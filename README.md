...
| [ccas-training-experiment-design.md](./ccas-training-experiment-design.md) | Training protocol. Variance-weighted DPO + supervised dimensional training, 2x2 ablation, Llama 3.1 8B with QLoRA, custom VarianceWeightedDPOTrainer. Budget: $4,200-8,400. |
